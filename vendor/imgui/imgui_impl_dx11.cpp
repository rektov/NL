...
bool    ImGui_ImplDX11_CreateDeviceObjects()
{
    ...
    if (bd->pd3dDevice->CreateVertexShader(nl::imgui_shaders::kVsBytecode, nl::imgui_shaders::kVsBytecodeSize, nullptr, &bd->pVertexShader) != S_OK)
        return false;
    ...
    if (bd->pd3dDevice->CreateInputLayout(local_layout, 3, nl::imgui_shaders::kVsBytecode, nl::imgui_shaders::kVsBytecodeSize, &bd->pInputLayout) != S_OK)
        return false;
    ...
    if (bd->pd3dDevice->CreatePixelShader(nl::imgui_shaders::kPsBytecode, nl::imgui_shaders::kPsBytecodeSize, nullptr, &bd->pPixelShader) != S_OK)
        return false;
